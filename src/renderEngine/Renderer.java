...
public class Renderer {
	...
	public void render(RawModel model) {
		...
		//Renderiza o VAO na tela usando a função glDrawArrays(). Neste caso, está renderizando triângulos, e o parâmetro model.getVertexCount() especifica o número de vértices que serão renderizados.
